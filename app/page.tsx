        ...
        <div className="lg:flex py-16 w-[640px] lg:w-[840px]">
          <div className="flex-col justify-center">
            ...
            <div className="justify-center flex-col">
                  <p className="text-black dark:text-white text-3xl text-center">Kaze W. K Wong</p>
                  <p className="text-gray-500 dark:text-gray-400 text-base text-center">Flatiron research fellow</p>
                  <p className="text-gray-500 dark:text-gray-400 text-base text-center">Flatiron institute</p>
            </div>
          </div>
            ...
            <div className="px-4 lg:w-2/3">
                ...
                <p className="text-gray-500 dark:text-gray-400 py-3 text-base">
                ...
                <p className="text-gray-500 dark:text-gray-400 py-3 text-base">Link to CV: <Link href="https://kazewong.github.io/CV" className='text-cyan-500 underline'>https://kazewong.github.io/CV</Link></p>
                <p className="text-gray-500 dark:text-gray-400 py-3 text-base">Publication profile: <Link href="https://inspirehep.net/authors/1789361?ui-citation-summary=true" className='text-cyan-500  underline'>https://inspirehep.net/authors/1789361?ui-citation-summary=true</Link></p>
                </div>
            </div>
        </div>
      {/* <ul className="">
